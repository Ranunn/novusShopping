...
<br></br>
 ...
 <div class="row">
			...
			<c:forEach items="${FaqList}" var="faq">
				...
				<tr>
					<td class ="tab1" >${faq.fNo}</td>
					<td class ="tab2" align="left" colspan="20">
							<a class="gogogo" >${faq.fQuestion }</a></td>
							<td class ="tab3" colspan="5"> </td>
					<td class ="tab1=4" colspan="10">${faq.writeDate}</td>
					<!-- 추가 -->
				</tr>
				<tr class="gogo"><td class="tddd">${faq.fAnswer}</td></tr>
			</c:forEach>
			</tbody>
			</table>
			</div></div></div></div>
