...
<br></br>
			...
			<!-- 1. 폼태그에 속성 추가  -->
		<form action="./saveQna.nv" method='post' enctype="multipart/form-data" > 
			<table id="qnaTable" border="0"  cellpadding="0" cellspacing="0"  >
				<!-- 2. 각 항목에  name 맞추기 -->
				<tr>
					<td bgcolor="orange" width="70" >제목</td>
					<td align="left"><input type="text"  size="60" name="qtitle"/></td>
				</tr>
				<tr>
					<td bgcolor="orange" >작성자</td>
					<td align="left"><input type="text" size="10" name="memId"/></td>
				</tr>
				<tr>
					<td bgcolor="orange" >내용</td>
					<td align="left"><textarea cols="60"  rows="10" name="qcontent"></textarea></td>
				</tr>
				<!-- 추가항목 시작 -->
				...
				<tr>
					...
					<input type="hidden" value="0:0:0:0:0:0:0:1" name="qip" > 
					</td>
				</tr>
				<tr>
				...
				<!-- 추가항목 끝 -->
				<tr>
					<td colspan="2" align="center"><input type="submit"	value=" 문의하기 " /></td>
				</tr>
			</table>
		</form>
