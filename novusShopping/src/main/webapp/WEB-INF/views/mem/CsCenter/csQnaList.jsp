...
<br></br>
 ...
 <div class="row">
			...
			<thead>
			<tr id ="tr1">
				<th class ="tabs" bgcolor="#fbb710" >번호</th>
				<th class ="tabs"  bgcolor="#fbb710" >제목</th>
				<th class ="tabs" bgcolor="#fbb710" >답변여부</th>
				<th class ="tabs" bgcolor="#fbb710" >등록일</th>
			...
			<c:forEach items="${QnaList}" var="qna">
				...
				<tr>
					<td>${qna.qno}</td>
					<td align="left"><a href="./csQnaDetail.nv?qno=${qna.qno}">
							${qna.qtitle }</a></td>
					<td>${qna.reply }</td>
					<td>${qna.writeDate }</td>
