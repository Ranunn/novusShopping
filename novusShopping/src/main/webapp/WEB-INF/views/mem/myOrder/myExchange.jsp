                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="saveExchange.nv" method="post" enctype="multipart/form-data">
                                <div class="row">
                                	...
                                	<div class="col-md-2 col-md-pull-2 mb-3">
	                                	<div><input type="radio" name="reviewSpeed" value="교환"/> 교환</div><br/>
	                                </div>
	                                <div class="col-md-2 mb-3">
	                                	<div><input type="radio" name="reviewSpeed" value="반품"/> 반품</div><br/>
	                                </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="content" name="content" cols="30" rows="10" placeholder="교환 / 반품 사유를 작성해주세요."></textarea>
                                    </div>
