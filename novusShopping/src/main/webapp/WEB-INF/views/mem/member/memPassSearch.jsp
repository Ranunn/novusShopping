                                        ...
                                        <div class="main-card mb-18 card">
                                            ...
                                            <h5 class="card-title">비밀번호 찾기</h5>
                                                <form id="passSearchForm"class="passSearch" action="passSearch.nv" method="post">
                                                    <div class="position-relative form-group"><label for="exampleName" class="search">아이디</label><input name="memId" id="exampleId" placeholder="아이디를 입력하세요" class="form-control"></div>
