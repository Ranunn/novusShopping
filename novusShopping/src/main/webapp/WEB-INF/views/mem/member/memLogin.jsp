                                    ...
                                    <div class="col-md-15">
                                        <div class="main-card mb-18 card">
                                            ...
                                            <h5 class="card-title">로그인</h5>
                                                <form method="post" action = "login.nv" name="memInput" id="memInput" >
                                               		<div class="position-relative form-group"><label for="exampleId" class="sign">아이디</label><input name="memId" id="exampleId" placeholder="아이디를 입력하세요" type="id" class="form-control"></div>
                                                    <div class="position-relative form-group"><label for="examplePass" class="sign">패스워드</label><input name="memPass" id="exampleName" placeholder="비밀번호를 입력하세요" type="pass" class="form-control"></div>
													<input type="button" name="Submit" class="Button" id="Submit" value="아이디찾기" onClick="location.href='memIdSearch.nv'">
													<input type="button" name="Submit" class="Button" id="Submit" value="비밀번호 찾기" onClick="location.href='memPassSearch.nv'">
													<input type="Submit" name="Submit" class="signButton" id="Submit" value="로그인">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
