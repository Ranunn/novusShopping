...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/tablet/ipad-2020-silver.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/tablet/ipad-2020-gold.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/tablet/ipad-2020-space.png);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-2020-silver.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-2020-silver.png" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-2020-gold.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-2020-gold.png" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-2020-space.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-2020-space.png" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="/novusShopping/item/ItemInfo/itemDetails8th.nv">
                                    <h6>아이패드 8세대 32GB</h6>
                                </a>
                                <!-- Ratings & Review -->
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/ipad-8th.jpg' >
   		</div>
