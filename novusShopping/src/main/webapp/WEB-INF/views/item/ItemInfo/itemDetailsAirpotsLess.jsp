...
<html>
<head>
<title>에어팟 2세대 무선 충전 케이스 모델</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/Ears/apple/airpot-all-light.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/Ears/apple/airpot-toplight.jpg);">
                                    </li>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/Ears/apple/airpot-all-light.jpg">
                                            <img class="d-block w-100" src="../../resources/Ears/apple/airpot-all-light.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/apple/airpot-toplight.jpg">
                                            <img class="d-block w-100" src="../../resources/Ears/apple/airpot-toplight.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/airpot-less.jpg' >
   		</div>
