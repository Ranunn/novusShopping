...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/phone/lg/wing-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/phone/lg/wing-back.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/phone/lg/wing-front-fold.jpg);">
                                    </li>
                                     <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/phone/lg/wing-back-fold.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/lg/wing-front.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/wing-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/wing-back.jpg">
                                            <img class="d-block w-100" src="../../resources/lg/wing-back.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/wing-front-fold.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/wing-front-fold.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/wing-back-fold.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/wing-back-fold.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	어디서나 더 큰 화면으로 즐겁게<br/>
                                	세우면 익숙하고,돌리면 편한 스위블 모드<br/>
                                	편안한 몰입감을 위한 99.6mm 세컨드 스크린<br/>
                                	더 편리하고 자유로운 멀티 스크린 UX<br/>
                                	흔들리지만, 흔들리지 않는듯 안정적인 짐벌 모션 카메라<br/>
                                	전후면 동시 촬영이 가능한 듀얼 레코딩 <br/>
                                	더 넓은 시야까지 담을 수 있는 초광각 카메라<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/lg-wing.jpg' >
   		</div>
