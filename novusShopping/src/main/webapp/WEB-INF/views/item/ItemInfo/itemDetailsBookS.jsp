...
<html>
<head>
<title>갤럭시 북 S Wi-Fi 33.7 cm Core™ i5 / 512 GB</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/notebook/galaxy-book-s-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/notebook/galaxy-book-s-top.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/notebook/galaxy-book-s-leftside.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/notebook/galaxy-book-s-rightside.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/notebook/galaxy-book-s-front.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/galaxy-book-s-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/galaxy-book-s-top.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/galaxy-book-s-top.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/galaxy-book-s-leftside.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/galaxy-book-s-leftside.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/galaxy-book-s-rightside.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/galaxy-book-s-rightside.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">1,420,000</p>
                                <a href="/novusShopping/item/ItemInfo/itemDetailsBookS.nv">
                                    <h6>갤럭시 북 S Wi-Fi 33.7 cm Core™ i5 / 512 GB</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	스마트폰의 장점을 더한 Wi-Fi 6 모바일 PC<br/>
                                	얇고 가벼운 디자인<br/>
                                	하루종일 사용할 수 있는 배터리<br/>
                                	때와 장소를 가리지 않는 선명한 화면<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxybook-s.jpg' >
   		</div>
