...
<!--                 <a href="http://twitter.com"><i class="fa fa-twitter" aria-hidden="true"></i></a> -->
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(/novusShopping/resources/phone/samsung/galaxy-note20-5g-black-all.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(/novusShopping/resources/phone/samsung/galaxy-note20-5g-bronze-all.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(/novusShopping/resources/phone/samsung/galaxy-note20-5g-green-all.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-5g-black-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-5g-black-all.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-5g-bronze-all.webp">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-5g-bronze-all.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-5g-green-all.webp">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-5g-green-all.webp" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	...
                                	3배 줌과 640만 화소로 선명한 카메라<br/>
                               		지문으로부터 자유로운 헤이즈 디자인<br/>
                                	미의 기준을 새롭게 제시하는 미스틱 컬러<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxy-note20.jpg' >
   		</div>
