...
<html>
<head>
<title>아이패드 프로 12.9형 128GB WIFI</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/tablet/ipad-pro-12-silver.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/tablet/ipad-pro-12-spacegray.png);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-pro-12-silver.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-pro-12-silver.png" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-pro-12-spacegray.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-pro-12-spacegray.png" alt="Second slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/ipad-pro-12.jpg' >
   		</div>
