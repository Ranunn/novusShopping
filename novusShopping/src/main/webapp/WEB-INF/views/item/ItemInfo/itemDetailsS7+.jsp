...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-front.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-back.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-front.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-back.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-front.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-front.webp" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-back.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticblack-back.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-front.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-front.webp" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-back.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-plus-5g-mysticbronze-back.webp" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="/novusShopping/item/ItemInfo/itemDetailS7+.nv">
                                    <h6>갤럭시 탭 S7+ 5G</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	대화면 디스플레이<br/>
                                	더 부드럽고 매끄러워진 화면 움직임<br/>
                                	실제 펜, 그 이상의 S펜<br/>
                                	완전히 새로워진 NEW 삼성 노트<br/>
                                	모든 것을 뒷바침하는 역대 최강 프로세서<br/>
                                	하루 종일 지속되는 배터리<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxy-tab-s7+.jpg' >
   		</div>
