...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/phone/apple/iphone-12-black.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/phone/apple/iphone-12-blue.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/phone/apple/iphone-12-green.png);">
                                    </li>
                                     <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/phone/apple/iphone-12-red.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="4" style="background-image: url(../../resources/phone/apple/iphone-12-white.png);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/apple/iphone-12-black.png">
                                            <img class="d-block w-100" src="../../resources/phone/apple/iphone-12-black.png" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/apple/iphone-12-mini-blue.png">
                                            <img class="d-block w-100" src="../../resources/phone/apple/iphone-12-blue.png" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/apple/iphone-12-mini-green.png">
                                            <img class="d-block w-100" src="../../resources/phone/apple/iphone-12-green.png" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/apple/iphone-12-mini-red.png">
                                            <img class="d-block w-100" src="../../resources/phone/apple/iphone-12-red.png" alt="Fourth slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/apple/iphone-12-mini-white.png">
                                            <img class="d-block w-100" src="../../resources/phone/apple/iphone-12-white.png" alt="Fifth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/iphone-12.jpg' >
   		</div>
