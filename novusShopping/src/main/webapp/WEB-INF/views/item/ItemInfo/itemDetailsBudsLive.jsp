...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/Ears/samsung/buds-live-mysticblack-casetop.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/Ears/samsung/buds-live-mysticred-casetop.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/Ears/samsung/buds-live-mysticbronze-casetop.webp);">
                                    </li>
                                     <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/Ears/samsung/buds-live-mysticwhite-casetop.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-mysticblack-casetop.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-mysticblack-casetop.webp" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-mysticred-casetop.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-mysticred-casetop.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-mysticbronze-casetop.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-mysticbronze-casetop.webp" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-mysticwhite-casetop.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-mysticwhite-casetop.webp" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="/novusShopping/item/ItemInfo/itemDetailsBudsLive.nv">
                                    <h6>갤럭시 버즈 라이브</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	인체공학적 설계로 편안한 착용감 귀에 쏙 들어가는 오픈형 디자인<br/>
                                	12mm 대형 스피커와 Bass Duct로 풍부하고 입체감 있는 라이브 사운드<br/>
                                	귀가 먹먹하지 않은 오픈형 ANC 저소음 모드 지원<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/buds-live.jpg' >
   		</div>
