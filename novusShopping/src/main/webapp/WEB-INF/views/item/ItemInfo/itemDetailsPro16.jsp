...
<html>
<head>
<title>맥북 프로 16형 2.6GHz 6코어 프로세서 512GB</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/notebook/macbookpro16-spacegray-top.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/notebook/macbookpro16-spacegray-foldside.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro16-spacegray-top.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro16-spacegray-top.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro16-spacegray-foldside.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro16-spacegray-foldside.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
									2.6GHz 6코어 9세대 Intel Core i7 프로세서<br />
									최대 4.5GHz Turbo Boost<br />
									AMD Radeon Pro 5300M(4GB GDDR6 메모리)<br />
									16GB 2666MHz DDR4 메모리<br />
									512GB SSD 저장 장치¹<br />
									True Tone이 적용된 16형 Retina 디스플레이<br />
									Magic Keyboard<br />
									Touch Bar 및 Touch ID<br />
									Thunderbolt 3 포트 4개<br />
								</p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/macbook-pro-16.png' >
   		</div>
