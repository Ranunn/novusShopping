                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/tablet/galaxy-tab-s7-mysticsilver-front.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/tablet/galaxy-tab-s7-mysticsilver-back.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-mysticsilver-front.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-mysticsilver-front.webp" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/galaxy-tab-s7-mysticsilver-back.webp">
                                            <img class="d-block w-100" src="../../resources/tablet/galaxy-tab-s7-mysticsilver-back.webp" alt="Second slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
