...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch3-LTE-mysticsilver-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch3-mysticbronze-front.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch3-LTE-mysticsilver-front.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch3-LTE-mysticsilver-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch3-mysticbronze-front.webp">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch3-mysticbronze-front.webp" alt="Second slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	스테인리스 바디와 프리미엄 가죽 스트랩 리얼워치의 감성을 담은 디자인<br/>
                                	40가지 운동 트래킹, 러닝 코칭 혈압 / 심전도 간편한 측정<br/>
                                	다양한 워치페이스와 스트랩으로 매일매일 새로운 스타일링<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxy-watch3-41.jpg' >
   		</div>
