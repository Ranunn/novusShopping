...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/tablet/ipad-air-silver.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/tablet/ipad-air-gold.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/tablet/ipad-air-blue.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/tablet/ipad-air-green.png);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="4" style="background-image: url(../../resources/tablet/ipad-air-spacegray.png);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-air-silver.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-air-silver.png" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-air-gold.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-air-gold.png" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-air-blue.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-air-blue.png" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-air-green.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-air-green.png" alt="Fourth slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/tablet/ipad-air-spacegray.png">
                                            <img class="d-block w-100" src="../../resources/tablet/ipad-air-spacegray.png" alt="Fifth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">779,000</p>
                                <a href="/novusShopping/item/ItemInfo/itemDetailsAir.nv">
                                    <h6>아이패드 에어4 64GB</h6>
                                </a>
                                <!-- Ratings & Review -->
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/ipad-air.jpg' >
   		</div>
