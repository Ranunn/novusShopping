...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/Ears/apple/airpot-all.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/Ears/apple/airpot-top.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/Ears/apple/airpot-ears.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/Ears/apple/airpot-all.jpg">
                                            <img class="d-block w-100" src="../../resources/Ears/apple/airpot-all.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/apple/airpot-top.jpg">
                                            <img class="d-block w-100" src="../../resources/Ears/apple/airpot-top.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/apple/airpot-ears.jpg">
                                            <img class="d-block w-100" src="../../resources/Ears/apple/airpot-ears.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	Apple 자체 디자인<br/>
                                	자동으로 켜지고, 자동으로 연결<br/>
                                	간편한 설정으로 당신의 모든 Apple 기기와 셋업 완료<br/>
                                	케이스에서 빠른 충전<br/>
                                	풍부한 고음질 오디오 및 음성<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/airpot-1.jpg' ><br/>
   			<img src='/novusShopping/resources/itemdetail/airpot-2.jpg' >
   		</div>
