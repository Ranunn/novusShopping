...
<html>
<head>
<title>맥북 프로 13형 Apple M1 칩(8코어 CPU 및 8코어 GPU) 512GB</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/notebook/macbookpro-spacegray-top.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/notebook/macbookpro-spacegray-fold.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/notebook/macbookpro-spacegray-side.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/notebook/macbookpro-spacegray-fold.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro-spacegray-top.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro-spacegray-top.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro-spacegray-fold.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro-spacegray-fold.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro-spacegray-side.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro-spacegray-side.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/macbookpro-spacegray-fold.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/macbookpro-spacegray-fold.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">1,960,000</p>
                                <a href="/novusShopping/item/ItemInfo/itemDetailsPro13.nv">
                                    <h6>맥북 프로 13형 Apple M1 칩(8코어 CPU 및 8코어 GPU) 512GB</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
									Apple M1 칩(8코어 CPU, 8코어 GPU, 16코어 Neural Engine)<br /> 
									8GB 통합	메모리 512GB SSD 저장 장치¹<br /> 
									True Tone이 탑재된 13형 Retina 디스플레이<br /> 
									Magic Keyboard<br />
									Touch Bar 및 Touch ID<br />
									Force Touch 트랙패드<br />
									Thunderbolt/USB 4 포트 2개<br />
								</p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/macbookpro.jpg' >
   		</div>
