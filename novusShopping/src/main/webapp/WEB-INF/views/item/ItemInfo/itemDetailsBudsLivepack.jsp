...
<html>
<head>
<title>갤럭시 버즈 라이브 스페셜 액세서리 패키지</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/Ears/samsung/buds-live-pack-black.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/Ears/samsung/buds-live-pack-bronze.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/Ears/samsung/buds-live-pack-white.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-pack-black.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-pack-black.webp" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-pack-bronze.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-pack-bronze.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/Ears/samsung/buds-live-pack-white.webp">
                                            <img class="d-block w-100" src="../../resources/Ears/samsung/buds-live-pack-white.webp" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/buds-live-pack.jpg' >
   		</div>
