...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/itemWatch/lg/w7-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/itemWatch/lg/w7-back.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/itemWatch/lg/w7-side.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/itemWatch/lg/w7-charge.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/itemWatch/lg/w7-front.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/lg/w7-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/lg/w7-back.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/lg/w7-back.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/lg/w7-side.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/lg/w7-side.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/lg/w7-charge.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/lg/w7-charge.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="/novusShopping/item/ItemInfo/itemDetailsW7.nv">
                                    <h6>엘지 W7</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	한 손으로 가볍게, 사용 시간은 오래도록<br/>
                                	선명한 Full HD IPS 디스플레이<br/>
                                	사이즈를 넘어서는 강력한 성능<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/lg-w7.png' >
   		</div>
