...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticblack-all.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticbronze-all.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticwhite-all.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticblack-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticblack-all.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticbronze-all.webp">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticbronze-all.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticwhite-all.webp">
                                            <img class="d-block w-100" src="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticwhite-all.webp" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	진짜 펜처럼 빨라진 스마트 S펜<br/>
                                	5배 광학 줌과 1억 8백만 화소로 선명한 카메라<br/>
                                	120Hz 주사율, 초고속 프로세서 파워 퍼포먼스<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxy-note20-ultra5g.jpg' >
   		</div>
