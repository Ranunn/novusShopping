...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/notebook/gram-16-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/notebook/gram-16-top.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/notebook/gram-16-back.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/notebook/gram-16-side.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/notebook/gram-16-front.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/gram-16-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/gram-16-top.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/gram-16-top.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/gram-16-back.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/gram-16-back.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/notebook/gram-16-side.jpg">
                                            <img class="d-block w-100" src="../../resources/notebook/gram-16-side.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">2,340,000</p>
                                <a href="/novusShopping/item/ItemInfo/itemDetailsGram.nv">
                                    <h6>그램 Gram 16형</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	대화면을 더 가볍게 기네스 세계 기록에서 인정한 휴대성<br/>
                                	약 2배 더 선명하게 WQXGA 초고해상도<br/>
                                	80Wh 대용량 배터리로 걱정없이 오래<br/>
                                	쓸수록 편안한 타이핑 반발력 높아진 키보드<br/>
                                	더 넓어진 면적으로 편의성을 높인 터치패드<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/gram16.jpg' >
   		</div>
