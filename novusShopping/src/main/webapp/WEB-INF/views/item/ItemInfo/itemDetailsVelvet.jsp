...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="../../item/ItemList/itemLG.nv">LG</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/phone/lg/velvet-gray-all.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/phone/lg/velvet-green-all.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/phone/lg/velvet-sunset-all.jpg);">
                                    </li>
                                     <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/phone/lg/velvet-white-all.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/lg/velvet-gray-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/velvet-gray-all.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/velvet-green-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/velvet-green-all.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/velvet-sunset-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/velvet-sunset-all.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/lg/velvet-white-all.jpg">
                                            <img class="d-block w-100" src="../../resources/phone/lg/velvet-white-all.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	물방울 카메라<br/>
                                	벨벳 터치 디자인<br/>
                                	부드러움을 터치하는 3D 아크 디자인<br/>
                                	감각적으로 나를 드러내는 컬러<br/>
                                	촬영과 편집이 쉽고 편리한 이지 크리에이션 카메라<br/>
                                	생생한 화질과 사운드로 감상하는 올레드 시네마뷰<br/>
                                	라이프 스타일을 반영한 프리미엄급 편의성<br/>
                                	충전이 빠른 대용량 배터리 & 편리한 무선충전<br/>
                                </p>
                            </div>
                            ...
                            <!-- Add to Cart Form -->
                             <form class="cart clearfix" method="post">
                                ...
                                <select name="color" class="phonecolor">
                                	<option value='오로라 그레이'>오로라 그레이</option>
                                	<option value='오로라 그린'>오로라 그린</option>
                                	<option value='일루전 선셋'>일루젼 선셋</option>
                                	<option value='오로라 화이트'>오로라 화이트</option>
                                </select>
                                </div>
                                </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/lg-velvet.jpg' >
   		</div>
