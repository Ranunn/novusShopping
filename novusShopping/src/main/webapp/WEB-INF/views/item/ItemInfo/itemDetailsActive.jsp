...
<html>
<head>
<title>갤럭시 워치 액티브2 40mm 블루투스</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="single-product-area section-padding-100 clearfix">
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="../../item/ItemList/itemWatch.nv">WATCH</a></li>
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch-active2-black-front.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch-active2-Gold-front.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch-active2-pink-front.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(../../resources/itemWatch/samsung/galaxy-watch-active2-silver-front.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch-active2-black-front.jpg">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch-active2-black-front.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch-active2-Gold-front.webp">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch-active2-Gold-front.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch-active2-pink-front.webp">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch-active2-pink-front.webp" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/itemWatch/samsung/galaxy-watch-active2-silver-front.webp">
                                            <img class="d-block w-100" src="../../resources/itemWatch/samsung/galaxy-watch-active2-silver-front.webp" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>
                                	사이즈와 소재까지 선택할 수 있는 내게 맞춘 가볍고 편안한 디자인<br/>
                                	터치 베젤과 모션 워치페이스가 지원되는 보다 넓어진 sAMOLED 디스플레이<br/>
                                	보다 정확해진 건강 트래킹 운동/수면/심박/스트레스 측정<br/>
                                </p>
                            </div>
         ...
         <!-- 제품 상세 내용 -->
        <div class="detail">
   			<img src='/novusShopping/resources/itemdetail/galaxy-watch-active2-40.jpg' >
   		</div>
