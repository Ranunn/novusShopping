                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- <img class="hover-img" src="../../resources/phone/samsung/galaxy-note20-ultra-5g-mysticblack-front.webp" alt=""> -->
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/tablet/ipad-pro-12-spacegray.png" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="/novusShopping/item/ItemInfo/itemDetailsPro.nv">
                                        <h6>아이패드 프로 12.9형 128GB WIFI</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/tablet/ipad-air-silver.png" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/tablet/ipad-air-gold.png" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/itemWatch/apple/watch6-40-alum-silver-black-front.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/itemWatch/apple/watch6-40-alum-silver-orange-front.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/itemWatch/apple/watch6-40-alum-rose-pink-front.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination justify-content-end mt-50">
                                <li class="page-item active"><a class="page-link" href="itemApple.nv">01.</a></li>
                                <li class="page-item"><a class="page-link" href="itemApple2.nv">02.</a></li>
