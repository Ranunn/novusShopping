            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-8">
						...
						<form action="cart.nv" method='post'>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>총 상품 금액 :</span> <span>${List.totalPrice}</span></li>
                                <li><span>배송비 :</span> <span>무료</span></li>
                                <li><span>총 결제 금액 :</span> <span>${List.totalPrice}</span></li>
                            </ul> --%>
                            <div class="cart-btn mt-100">
                                <a href="/novusShopping/mem/myOrder/buyItem.nv" class="btn amado-btn w-100">결제하기</a>
                            </div>
                        </div>
                    </div>
                </div>
