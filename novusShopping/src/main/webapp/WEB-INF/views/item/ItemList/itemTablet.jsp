            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="itemTablet.nv">태블릿PC</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/tablet/ipad-2020-silver.png" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/tablet/ipad-2020-space.png" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/tablet/gpad-all.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/tablet/gpad-back2.jpg" alt="">
                            </div>
