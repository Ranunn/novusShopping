        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget brands mb-50">
                ...
                <div class="widget-desc">
                    ...
                    <div class="catagories-menu">
                        <ul>
                        	<li class="active"><a href="itemApple.nv">APPLE</a></li>
                        </ul>
                    </div>
                    <!-- Single Form Check -->
                    <div class="catagories-menu">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/Ears/apple/airpot-all.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/apple/airpot-top.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="/novusShopping/item/ItemInfo/itemDetailAirpots.nv">
                                        <h6>에어팟 2세대 충전 케이스 모델</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/Ears/apple/airpot-all-light.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/apple/airpot-toplight.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="/novusShopping/item/ItemInfo/itemDetailsAirpotsLess.nv">
                                        <h6>에어팟 2세대 무선 충전 케이스 모델</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/apple/airpot-pro-ears.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/etc/applepencil_1st_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/etc/applepencil_1st_2.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="/novusShopping/item/ItemInfo/itemDetailsPencil1st.nv">
                                        <h6>애플펜슬 1세대</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                    ...
                    <div class="col-12">
                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination justify-content-end mt-50">
                                <li class="page-item"><a class="page-link" href="itemApple.nv">01.</a></li>
                                <li class="page-item active"><a class="page-link" href="itemApple2.nv">02.</a></li>
                                <li class="page-item"><a class="page-link" href="itemApple3.nv">03.</a></li>
