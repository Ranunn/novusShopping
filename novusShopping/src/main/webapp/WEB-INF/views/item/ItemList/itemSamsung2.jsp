                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="../../resources/notebook/galaxy-book-flex-blue-front.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/galaxy-book-flex-blue-top.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/notebook/galaxy-book-flex-gray-front.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/galaxy-book-flex-gray-top.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/galaxy-book-s-top.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/Ears/samsung/buds-live-pack-black.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/samsung/buds-live-pack-bronze.webp" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    <div class="line"></div>
                                    <p class="product-price">198,000</p>
                                    <a href="/novusShopping/item/ItemInfo/itemDetailsBudsLivepack.nv">
                                        <h6>갤럭시 버즈 라이브 스페셜 액세서리 패키지</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/Ears/samsung/buds-plus-black-casetop.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/samsung/buds-plus-red-casetop.webp" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/Ears/samsung/buds-live-mysticblack-casetop.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/Ears/samsung/buds-live-mysticred-casetop.webp" alt="">
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination justify-content-end mt-50">
                                <li class="page-item"><a class="page-link" href="itemSamsung.nv">01.</a></li>
                               	<li class="page-item active"><a class="page-link" href="itemSamsung2.nv">02.</a></li>
