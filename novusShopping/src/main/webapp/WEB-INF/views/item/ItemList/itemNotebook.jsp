            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="itemNotebook.nv">노트북</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/notebook/gram-16-front.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/gram-16-top.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/notebook/macbookpro-spacegray-top.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/macbookpro-spacegray-fold.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/notebook/macbookpro16-spacegray-top.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/notebook/macbookpro16-spacegray-foldside.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="/novusShopping/item/ItemInfo/itemDetailsPro16.nv">
                                        <h6>맥북 프로 16형 2.6GHz 6코어 프로세서 512GB</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
