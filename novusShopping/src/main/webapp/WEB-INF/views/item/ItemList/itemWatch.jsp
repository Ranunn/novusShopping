            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="itemWatch.nv">스마트워치</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/itemWatch/samsung/galaxy-fit2-dynamicblack-front.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/itemWatch/samsung/galaxy-fit2-dynamicscarlet-front.webp" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/itemWatch/lg/w7-front.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/itemWatch/lg/w7-back.jpg" alt="">
                            </div>
