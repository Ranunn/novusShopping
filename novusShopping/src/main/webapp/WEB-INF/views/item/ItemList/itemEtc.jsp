    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.nv" class="cart-nav"><img src="../../resources/core-img/cart.png" alt=""> Cart <span></span></a>
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="itemEtc.nv">기타 전자기기</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/etc/applepencil_2nd_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/etc/applepencil_2nd_2.jpg" alt="">
                            </div>
